...
function FloatingPin({ x, y, delay }: { x: string; y: string; delay: number }) {
  return (
    ...
    >
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-full h-full text-amber-400/60">
...
export default function HeroSection() {
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center px-4 overflow-hidden">
      ...
      >
        <motion.p
          className="text-sm md:text-base text-amber-300/80 mb-6 tracking-widest uppercase"
